...
class ENet(nn.Module):
    ...
    def __init__(self, num_classes, encoder_relu=False, decoder_relu=True):
        ...
        # Stage 35Test - Decoder
        self.upsample35_0 = UpsamplingBottleneck(
            128, 64, dropout_prob=0.1, relu=decoder_relu)
        self.regular35_1 = RegularBottleneck(
            64, padding=1, dropout_prob=0.1, relu=decoder_relu)
        self.regular35_2 = RegularBottleneck(
            64, padding=1, dropout_prob=0.1, relu=decoder_relu)
        ...
        self.upsample5_0 = UpsamplingBottleneck(
            32, 16, dropout_prob=0.1, relu=decoder_relu)
    ...
    def forward(self, x):
        ...
        # Stage 3.5 - Decoder
        x = self.upsample35_0(x, max_indices3_0, output_size=stage3_input_size)
        x = self.regular35_1(x)
        x = self.regular35_2(x)
